    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-10">
          <h1 className="text-5xl font-extrabold text-white mb-4">Social AI Studio</h1>
          <p className="text-white/80 text-lg max-w-xl mx-auto">
            Smart, AI-powered tools for captions, mood analysis, and hashtag discovery.
          </p>
        </div>
        ...
        <div className="flex justify-center mb-10">
          <div className="bg-white/20 backdrop-blur-md rounded-xl p-2 flex space-x-2">
            {[
              { id: 'caption', label: 'Caption Generator', desc: 'Create engaging captions', gradient: 'instagram-gradient' },
              { id: 'mood', label: 'Mood Analyzer', desc: 'Understand sentiment', gradient: 'twitter-gradient' },
              { id: 'hashtags', label: 'Hashtag Finder', desc: 'Boost reach instantly', gradient: 'social-gradient' }
            ].map(tab => (
              <button
                key={tab.id}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {activeTab === 'caption' && (
            <div className="tab-content">
              <div className="social-card rounded-xl p-8">
                <h2 className="text-2xl font-bold text-white mb-4">Caption Generator</h2>
                <p className="text-white/80 mb-6">
                  Describe your photo and instantly get a creative, ready-to-post caption.
                </p>
                ...
                <div className="space-y-5">
                  <textarea
                    ...
                    placeholder="Example: A peaceful sunset at the beach with close friends."
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 instagram-gradient text-white rounded-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg transition-all"
                  >
          ...
          {activeTab === 'mood' && (
            <div className="tab-content">
              <div className="social-card rounded-xl p-8">
                <h2 className="text-2xl font-bold text-white mb-4">Mood Analyzer</h2>
                <p className="text-white/80 mb-6">
                  Paste any text to uncover its emotional tone and overall sentiment.
                </p>
                ...
                <div className="space-y-5">
                  <textarea
                    ...
                    placeholder="Paste a tweet, comment, or any text to analyze..."
                    className="w-full h-32 p-4 rounded-lg border-0 bg-white/20 text-white placeholder-white/60 focus:ring-2 focus:ring-white/30 resize-none"
                  />
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 twitter-gradient text-white rounded-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg transition-all"
                  >
          ...
          {activeTab === 'hashtags' && (
            <div className="tab-content">
              <div className="social-card rounded-xl p-8">
                <h2 className="text-2xl font-bold text-white mb-4">Hashtag Finder</h2>
                <p className="text-white/80 mb-6">
                  Enter keywords and get optimized hashtags to maximize your reach.
                </p>
                ...
                <div className="space-y-5">
                  <input
                    ...
                    placeholder="Example: travel photography nature"
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 social-gradient text-white rounded-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg transition-all"
                  >
        ...
        <div className="text-center mt-12 text-white/70 text-sm">
          <p>Designed for creators, marketers, and storytellers — elevate your social presence with AI.</p>
        </div>
      </div>
    </div>
  )
